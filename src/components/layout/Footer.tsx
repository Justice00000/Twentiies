    ...
    <footer className="bg-cream text-charcoal">
      <div className="container mx-auto py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          {/* Quick Links */}
          <div className="space-y-4">
            <h4 className="font-heading text-lg font-medium text-charcoal">{t("quickLinks")}</h4>
          ...
          {/* Services */}
          <div className="space-y-4">
            <h4 className="font-heading text-lg font-medium text-charcoal">{t("services")}</h4>
            <nav className="flex flex-col gap-2">
          ...
          {/* Contact */}
          <div className="space-y-4">
            <h4 className="font-heading text-lg font-medium text-charcoal">{t("contactUs")}</h4>
