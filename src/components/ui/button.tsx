  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-body",
  {
    variants: {
      variant: {
        ...
        gold: "bg-gold text-accent-foreground hover:bg-gold-light font-semibold tracking-wide",
        hero: "bg-foreground text-background border-2 border-foreground hover:bg-transparent hover:text-foreground tracking-widest uppercase text-xs font-semibold",
        "hero-outline": "bg-transparent text-foreground border-2 border-foreground hover:bg-foreground hover:text-background tracking-widest uppercase text-xs font-semibold",
        whatsapp: "bg-[#25D366] text-background hover:bg-[#128C7E] font-semibold",
      },
      size: {
